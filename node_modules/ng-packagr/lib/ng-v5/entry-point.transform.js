 ...
 */
exports.entryPointTransformFactory = (renderStylesheets, renderTemplates, transformTsSources, compileTs, writeBundles, writePackage) => rxjs_1.pipe(
...
writeBundles, writePackage, transform_1.transformFromPromise((graph) => __awaiter(this, void 0, void 0, function* () {
    const entryPoint = graph.find(nodes_1.byEntryPoint().and(select_1.isInProgress));
